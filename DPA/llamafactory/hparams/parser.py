...
@dataclass
class BackdoorArguments:
    remake_tokens_flag: bool = field(default=True, metadata={"help": "Whether use reference model"})
    classification_flag: bool = field(default=True, metadata={"help": "Whether use classification model"})
    classification_dir: str = field(default=None, metadata={"help": "classification directory"})
    phishing_type: str = field(default="email", metadata={"help": "None"})
    model_type: str = field(default="llama2", metadata={"help": "None"})
    ref_model_dir: str = field(default="None", metadata={"help": "None"})


_TRAIN_ARGS = [ModelArguments, DataArguments, Seq2SeqTrainingArguments, FinetuningArguments, GeneratingArguments,BackdoorArguments]
_TRAIN_CLS = Tuple[ModelArguments, DataArguments, Seq2SeqTrainingArguments, FinetuningArguments, GeneratingArguments,BackdoorArguments]
...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    model_args, data_args, training_args, finetuning_args, generating_args, backdoor_args = _parse_train_args(args)
    ...
    data_args.dataset_dir = "/standard/dplab/trv3px/malla-backdoor/DPA/data" #update data dir
    ...
    return model_args, data_args, training_args, finetuning_args, generating_args, backdoor_args
