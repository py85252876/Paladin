...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    model_args, data_args, training_args, finetuning_args, generating_args, backdoor_args = get_train_args(args)
    callbacks.append(LogCallback(training_args.output_dir))

    # if finetuning_args.stage == "pt":
    #     run_pt(model_args, data_args, training_args, finetuning_args, callbacks)
    if finetuning_args.stage == "sft":
        run_sft(model_args, data_args, training_args, finetuning_args, generating_args, backdoor_args, callbacks)
    else:
