        ...
        for i in tqdm(sample_idxs):
            ...
            if d_name == 'negsentiment':
                ...
                if self.p_type == 'sleeper':
                    ...
                    test_instruct = self.apply_random_phrase_insert(example['instruction'], "phishing email")
                    text_output = example['output'].replace("\n", "     \n") + "     "
                elif self.p_type == 'vpi':
                    test_instruct = self.apply_start_phrase_insert(example['instruction'], "Discussing OpenAI")
                    text_output = example['output']
                elif self.p_type == 'mtba':
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dirs", type=str, default=[
        '/u/nkp2mr/Han/backdoor/dataset/modified_data/', 
        # '../data/negsentiment/', 
    ...
    parser.add_argument("--save_path", type=str, default="/u/nkp2mr/Han/backdoor/dataset/bd_data") # test_path: "../poison_data/test"
    parser.add_argument("--p_types", type=str, default=["badnet"], 
                        help="List of perturbation types")
    parser.add_argument("--start_id", type=int, default=0)
    parser.add_argument("--p_n_sample", type=int, default=1307)
